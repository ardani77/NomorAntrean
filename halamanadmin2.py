...
from halamanadmin3 import TambahUser_Window


class LihatUser_Window(object):
...
##        self.listname = admintousercontroller.showAllUser()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.clicked.connect(lambda: self.pushAddUser(MainWindow))

##    def showUser(self, MainWindow):


    def pushAddUser(self, MainWindow):
        self.halamanadmin3 = TambahUser_Window(self.username)
        MainWindow.close()
